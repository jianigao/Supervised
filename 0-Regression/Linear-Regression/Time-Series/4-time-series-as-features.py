...
flu_trends = pd.read_csv("Datasets/flu-trends.csv")
...
# 
# We'll see strategies for handling this problem in Lesson 6. For this example, we'll just use values from a test set.
